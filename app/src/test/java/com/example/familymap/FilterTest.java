...
public class FilterTest {
    ...
    @Test
    public void fathersSideTest() throws Exception {
        clearDatabase();
        initializeSettings();
        loadData();
        login();
        ...
        ArrayList<Event> events = filter.filterEvents();

        Event dadBirthEvent = null;
        Person loggedInUser = getPerson(Globals.getInstance().getLoginResult().personID);
        for (Event e : Globals.getInstance().getEventListResult().getData()) {
            Person p = getPerson(e.getPersonID());
            if (loggedInUser.getFatherID() == p.getFatherID()) {
                dadBirthEvent = e;
                break;
            }
        }
        assertEquals(true, events.contains(dadBirthEvent));

        Settings.getInstance().fathersSide = false;
        events.clear();
        dadBirthEvent = null;
        for (Event e : Globals.getInstance().getEventListResult().getData()) {
            Person p = getPerson(e.getPersonID());
        ...
        assertEquals(false, events.contains(dadBirthEvent));
    }

    @Test
    public void mothersSideTest() throws Exception {
        clearDatabase();
        initializeSettings();
        loadData();
        login();
        ...
        assertEquals(true, events.contains(momBirthEvent));

        Settings.getInstance().mothersSide = false;
        events.clear();
        momBirthEvent = null;
        for (Event e : Globals.getInstance().getEventListResult().getData()) {
            Person p = getPerson(e.getPersonID());
        ...
        assertEquals(false, events.contains(momBirthEvent));
    }

    @Test
    public void maleEventTest() throws Exception {
        clearDatabase();
        initializeSettings();
        loadData();
        login();
        ...
        assertEquals(true, events.contains(dadEvent));
        ...
        assertEquals(false, events.contains(dadEvent));
    }

    @Test
    public void femaleEventTest() throws Exception {
        clearDatabase();
        initializeSettings();
        loadData();
        login();
        ...
        assertEquals(true, events.contains(femaleEvent));
        ...
        assertEquals(false, events.contains(femaleEvent));
    }
